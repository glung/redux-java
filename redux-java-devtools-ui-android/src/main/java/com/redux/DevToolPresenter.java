...
public class DevToolPresenter<A extends Action, S extends State> {
    ...
    private static class Adapter<A extends Action, S extends State> extends RecyclerView.Adapter<ViewHolder> {
